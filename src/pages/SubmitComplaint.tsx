...
export const SubmitComplaint: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newComplaint: Complaint = {
      ...
      studentName: finalAnonymous ? 'Anonymous' : currentStudent.name,
      studentId: finalAnonymous ? 'Anonymous' : currentStudent.zprn,
      studentEmail: finalAnonymous ? 'Anonymous' : currentStudent.email,
      createdAt: Date.now(),
      status: 'Pending',
      priority,
      mlScore,
